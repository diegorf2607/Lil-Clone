...
export default function AdminPage() {
  ...
  const packStats = {
    ...
    packBookings: appointments.filter((apt) => apt.isPack).length,
    regularBookings: appointments.filter((apt) => !apt.isPack).length,
  }
                        ...
                        {timeSlots.map((time) => (
                          ...
                          >
                            ...
                            {weekDays.map((day, dayIndex) => {
                              ...
                              const hasContent =
                                occupation || appointments.some((apt) => apt.day === dayIndex && apt.time === time)
